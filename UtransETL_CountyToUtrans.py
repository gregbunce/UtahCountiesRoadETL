...
from UtransETL_FieldMappingFunctions import Washington, Utah, Davis, Weber, SaltLake, Beaver, BoxElder, Carbon, Wasatch, Duchesne, Iron, Summit, Tooele, Morgan, Cache, Daggett, Emery, Grand, SanJuan, Kane, Rich, Piute, Sevier, Wayne
import arcpy, os
